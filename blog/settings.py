...
SECRET_KEY = 'django-insecure-ky_f@f+ni2jktr$())o45^1)g+c=gl$5_p%4f5b5#5nry1^!%-'
...
DATA_UPLOAD_MAX_MEMORY_SIZE = 15485760  # 20MB in bytes
...
STATICFILES_DIRS = ['static/css', 'static/js', 'static/img']
...
EMAIL_HOST_PASSWORD = 'the password from Google>Settings>Security>Application password'
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'zof.dobrowolska@gmail.com'
        ...
        'toolbar_YourCustomToolbarConfig': [
            ...
            {'name': 'insert',
             'items': ['Image', 'Flash', 'Table', 'HorizontalRule', 'Smiley', 'SpecialChar', 'PageBreak', 'Iframe',
                       'Youtube', 'pasteFromGoogleDoc', 'nbsp']},
            '/',
